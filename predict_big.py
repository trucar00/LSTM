...
df_predict = pd.read_parquet("three_months/feats_all_gear2/2025_4_6_feats.parquet")
...
df_predict.to_parquet("predictions/2025_4_6_w_full_2023_2024_model_tuned.parquet", index=False)
