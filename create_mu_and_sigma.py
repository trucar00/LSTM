...
files = [
    ...
    #"three_months/feats_all_w_traps_online/2024_7_9_feats.parquet",
    #"three_months/feats_all_w_traps/2024_10_12_feats.parquet"
]

BASE_FEATURES = ["cog_sin", "cog_cos", "speed_calc_ms", "ra_accel", "ra_jerk", "log_dist", "ra_dcog", "log_dt"] # no dist
...
mu_sigma_path = Path(f"tuning/parameters_2024_1_6_ALL_GEAR_no_DIST.pkl")# 
